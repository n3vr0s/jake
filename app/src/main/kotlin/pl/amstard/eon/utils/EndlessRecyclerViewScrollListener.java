...
public class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        // If the total item starCount is zero and the previous isn't, assume the
        ...
        // If it’s still loading, we check to see if the dataset starCount has
        // changed, if so we conclude it has finished loading and update the current page
        // number and total item starCount.
